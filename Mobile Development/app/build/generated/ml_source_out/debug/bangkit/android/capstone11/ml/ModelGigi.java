package bangkit.android.capstone11.ml;
...
public final class ModelGigi {
  @NonNull
  private final Model model;

  private ModelGigi(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "model_gigi.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static ModelGigi newInstance(@NonNull Context context) throws IOException {
    return new ModelGigi(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static ModelGigi newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new ModelGigi(context, options);
  }
